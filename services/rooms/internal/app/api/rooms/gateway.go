...
import (
	...
	"github.com/sedorofeevd/project-druzya/services/rooms/internal/tools/humanerror"
...
func newGatewayMux(ctx context.Context, endpoint string) (http.Handler, error) {
	...
	if err := roomsv1.RegisterRoomsServiceHandlerFromEndpoint(ctx, mux, endpoint, dialOpts); err != nil {
		return nil, err
	}
	return mux, nil
}
