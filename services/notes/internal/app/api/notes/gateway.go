...
import (
	...
	"github.com/sedorofeevd/project-druzya/services/notes/internal/tools/humanerror"
...
func newGatewayMux(ctx context.Context, endpoint string) (http.Handler, error) {
	...
	if err := notesv1.RegisterNotesServiceHandlerFromEndpoint(ctx, mux, endpoint, dialOpts); err != nil {
		return nil, err
	}
