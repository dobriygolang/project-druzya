...
import (
	...
	"github.com/sedorofeevd/project-druzya/services/focus/internal/tools/humanerror"
...
func newGatewayMux(ctx context.Context, endpoint string) (http.Handler, error) {
	...
	if err := focusv1.RegisterFocusServiceHandlerFromEndpoint(ctx, mux, endpoint, dialOpts); err != nil {
		return nil, err
	}
