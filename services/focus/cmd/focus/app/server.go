...
import (
	...
	focusapi "github.com/sedorofeevd/project-druzya/services/focus/internal/app/api/focus"
...
func RunAPI(ctx context.Context, a *App) error {
	...
	grpcSrv := grpc.NewServer(grpc.ChainUnaryInterceptor(
		focusapi.AuthInterceptor(a.JWT),
	))
	focusapi.NewRegisteredImplementation(grpcSrv, a.Service)
