...
import (
	...
	events "github.com/sedorofeevd/project-druzya/services/interview/internal/adapter/events"
...
func (_c *Publisher_Publish_Call) RunAndReturn(run func(context.Context, events.Event) error) *Publisher_Publish_Call {
	_c.Call.Return(run)
	return _c
}
