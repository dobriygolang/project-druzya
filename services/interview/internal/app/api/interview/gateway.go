...
import (
	...
	"github.com/sedorofeevd/project-druzya/services/interview/internal/tools/humanerror"
...
func newGatewayMux(ctx context.Context, endpoint string) (http.Handler, error) {
	...
	if err := interviewv1.RegisterInterviewServiceHandlerFromEndpoint(ctx, mux, endpoint, dialOpts); err != nil {
		return nil, err
	}
