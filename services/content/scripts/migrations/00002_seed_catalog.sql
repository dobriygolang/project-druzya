...
DELETE FROM rubrics WHERE id IN (
    'd0000000-0000-4000-8000-000000000001',
    'd0000000-0000-4000-8000-000000000002'
);
DELETE FROM task_solutions WHERE id IN (
    'c0000000-0000-4000-8000-000000000001',
    'c0000000-0000-4000-8000-000000000002',
    'c0000000-0000-4000-8000-000000000003'
);
DELETE FROM template_section_tasks WHERE section_id IN (
    'a0000000-0000-4000-8000-000000000003',
    'a0000000-0000-4000-8000-000000000004'
);
...
DELETE FROM template_sections WHERE id IN (
    'a0000000-0000-4000-8000-000000000003',
    'a0000000-0000-4000-8000-000000000004'
);
DELETE FROM interview_templates WHERE id = 'a0000000-0000-4000-8000-000000000002';
DELETE FROM companies WHERE id = 'a0000000-0000-4000-8000-000000000001';
-- +goose StatementEnd
