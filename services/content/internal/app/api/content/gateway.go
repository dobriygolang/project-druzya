...
import (
	...
	"github.com/sedorofeevd/project-druzya/services/content/internal/tools/humanerror"
...
func newGatewayMux(ctx context.Context, endpoint string) (http.Handler, error) {
	...
	if err := contentv1.RegisterContentServiceHandlerFromEndpoint(ctx, mux, endpoint, dialOpts); err != nil {
		return nil, err
	}
