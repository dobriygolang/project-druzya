...
export const FEATURES: FeatureEntry[] = [
  ...
  // ── Phase 5: Billing ──────────────────────────────────────────────────
  {
    ...
    note: 'Plan catalog from migration seeds; checkout UI pending',
  ...
  // ── Phase 6: Today ────────────────────────────────────────────────────
  {
    ...
    note: 'Backend-only cards; legacy localStorage goal/activity removed',
