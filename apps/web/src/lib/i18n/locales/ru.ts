...
export const ru = {
  ...
  tracker: {
    ...
    dragHandle: 'Перетащить задачу',
    reorderFilteredHint: 'Сбросьте фильтры, чтобы менять порядок перетаскиванием',
    noTasks: 'Нет задач',
    restoreTask: 'Вернуть',
    export: 'Экспорт',
    exportCopied: 'Markdown скопирован в буфер',
    addToSprint: 'В спринт',
    openTracker: 'Открыть трекер',
    noActiveSprint: 'Нет активного спринта',
    noActiveSprintHint: 'Создайте спринт, чтобы добавлять и отслеживать задачи.',
    startSprint: 'Начать спринт',
    overviewActive: 'Активный спринт',
    overviewArchived: 'В архиве',
    overviewEpics: 'Эпики',
    overviewTasks: 'Задачи в спринте',
    filterLabelKind: 'Тип',
    filterLabelEpic: 'Эпик',
    noEpic: 'Без эпика',
    sprintEndsIn: '{{days}} дн. до конца спринта',
    sprintEndsToday: 'Спринт заканчивается сегодня',
    sprintEnded: 'Срок спринта истёк — можно архивировать',
    epicTaskCount: '{{count}} задач',
    newSprintHint: 'Текущий спринт будет автоматически отправлен в архив.',
    epicDone: 'Завершён',
    epicOpen: 'В работе',
    epicProgress: '{{done}}/{{total}} задач',
    epicAutoDoneHint: 'Эпик закрывается, когда все его задачи выполнены (включая архивные спринты).',
    ...
    epicDeferSprint: 'Следующий спринт',
    epicIncludeSprint: 'Этот спринт',
    epicDeferShort: 'Потом',
    epicIncludeShort: 'Сейчас',
    epicNextSprint: 'След. спринт',
    deferredEpicsSection: 'Отложено на следующий спринт',
    deferredEpicsHint: 'Задачи остаются в спринте, но не попадают в Today и новые рекомендации, пока вы снова не включите эпик.',
    estimateDays: 'Оценка',
    estimateDaysShort: '{{days}} д',
    sprintCapacity: '{{used}} / {{capacity}} дн.',
    sprintCapacityOver: 'Перегруз: +{{over}} дн. сверх лимита',
    sprintCapacityHint: '14-дневный спринт ≈ 10 рабочих дней. Можно добавить больше — полоска покажет перегруз.',
    sprintTasksProgress: 'Задачи',
  ...
  welcome: {
    ...
    heroTitle: 'Mock, план на сегодня и AI-разбор — в одном месте.',
    heroBody:
      'Проходи mock-интервью, получай оценку и задачи на повтор. Today собирает готовность, план дня и слабые места из трекера.',
    howItWorks: 'Как это работает →',
    bulletMocks: '2 mock-интервью в месяц бесплатно',
    bulletToday: 'План на Today из трекера задач',
    bulletLive: 'Live coding с напарником',
    mockReadiness: 'Готовность',
    mockPlan: 'Задачи на сегодня',
    mockRec1Title: 'Повторить dynamic programming',
    mockRec1Sub: 'Слабое место после mock',
    mockRec2Title: 'System design: rate limiter',
    mockRec2Sub: 'Следующий шаг в плане',
    mockRec3Title: 'Behavioral: конфликт в команде',
    mockRec3Sub: 'Из очереди повторов',
    demo: {
      ariaLabel: 'Демо: mock, AI-оценка и план на Today',
      stepsAria: 'Шаги демо',
      stepMock: 'Mock',
      stepAi: 'AI',
      stepToday: 'Today',
      caption: 'После mock план на Today обновляется сам',
      mockEyebrow: 'Алгоритмы · mock',
      mockQuestion: 'Two Sum',
      mockHint: 'Верни индексы двух чисел с суммой target. Решение отправляется на оценку.',
      mockSubmit: 'Отправить ответ',
      aiEyebrow: 'AI-разбор',
      aiFeedback: 'Решение верное, но сложность O(n²). Можно ускорить до O(n) через hash map.',
      aiWeakLabel: 'Слабое место',
      aiWeak: 'Dynamic programming',
      aiNote: 'Оценка и фидбек — сразу после попытки',
      todayReadiness: 'Готовность',
      todayPlan: 'Задачи на сегодня',
      todayTaskNew: 'Повторить dynamic programming',
      todayTaskNewSub: 'Добавлено после mock',
      todayTask2: 'System design: rate limiter',
      todayTask2Sub: 'Следующий шаг в плане',
    },
    featuresEyebrow: 'Что внутри',
    featuresTitle: 'От mock до плана на день',
    featuresBody:
      'Интервью, оценка, трекер задач и live coding — без лишнего шума и геймификации.',
    ...
    featTodayTitle: 'Today и задачи',
    featTodayText:
      'Готовность, план на день, очередь повторов и спринт — синхронизируются с mock и трекером.',
    ...
    pricingBody: '14 дней Pro бесплатно — карта не нужна. Оформление подписки в профиле или на странице тарифов.',
    pricingMore: 'Сравнить тарифы и оформить Pro →',
    footerTagline: 'Mock-интервью, план на день и AI-разбор для подготовки к техническим собеседованиям.',
  },
  live: {
    brand: 'druzya code',
