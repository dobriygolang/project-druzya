...
export const ru = {
  ...
  tracker: {
    ...
    epicAutoDoneHint: 'Эпик закрывается автоматически, когда все его задачи выполнены.',
    estimateDays: 'Оценка',
    estimateDaysShort: '{{days}} д',
    sprintCapacity: '{{used}} / {{capacity}} дн.',
    sprintCapacityOver: 'Перегруз: +{{over}} дн. сверх лимита',
    sprintCapacityHint: 'Ориентир — 5 рабочих дней на спринт. Можно добавить больше, но полоска покажет перегруз.',
