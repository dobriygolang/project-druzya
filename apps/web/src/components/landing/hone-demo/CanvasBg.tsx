...
export type DemoCanvasTheme = 'winter' | 'particles'

interface CanvasBgProps {
  theme?: DemoCanvasTheme
  reducedMotion?: boolean
}

export function CanvasBg({ theme = 'winter', reducedMotion = false }: CanvasBgProps) {
  if (reducedMotion) {
    return <StaticBg />
  }
  if (theme === 'particles') {
...
function readInkRgb(el: Element): [number, number, number] {
