...
// бесполезен. См. Notes parent: handleCreate, handleDelete — useCallback с устойчивыми deps.
export const Sidebar = memo(SidebarImpl);

function SidebarImpl({ list, selectedId, folders, selectedFolder, onSelectFolder, onCreateFolder, onDeleteFolder, onMoveNote, onSelect, onCreate, onDelete, onToggleCollapse }: SidebarProps) {
  const t = useT();
